...
function title() {
console.clear()
console.log(chalk.bold.green(figlet.textSync('KomodoBot', {
font: 'Standard',
...
console.log(chalk.yellow(`\n                        ${chalk.yellow('[ Created By Komodo ]')}\n\n${chalk.red('KomodoBot')} : ${chalk.white('WhatsApp Bot Multi Device')}\n${chalk.red('Follow Insta Dev')} : ${chalk.white('@komodostore.id')}\n${chalk.red('Message Me On WhatsApp')} : ${chalk.white('+62 812-3187-9750')}\n${chalk.red('Donate')} : ${chalk.white('081225018781 ( Dana/Pulsa )')}\n`))
}
...
browser: ['KomodoBot','Safari','1.0.0'],
auth: state
})
title()
store.bind(Manik.ev)
...
let fmanik = './media/Manik.jpg'
  var ftxt = {
	 ...
	 message: { "imageMessage": {"jpegThumbnail": await reSize(fmanik, 300, 300),"caption": `Group Announce ~ KomodoBot By Komodo`  }}
  }
